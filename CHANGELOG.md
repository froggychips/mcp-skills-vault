...
* **ci:** npm refuses provenance from a self-hosted runner ([a8a08d2](https://github.com/froggychips/mcp-skills-vault/commit/a8a08d2e4945cdea3793ca48ed8e870b6fe4c301))
...
* the cache's last resort was a path every user on the machine could guess ([4f58a3a](https://github.com/froggychips/mcp-skills-vault/commit/4f58a3a9d1de4de04415a9827adf36f8c9022f08))
